...
const integrations = [
  ...
  ['okta', 'Okta', 'Identity provider', 'Workspace reference for identity records.', 'configured', 'Northwind Okta'],
  ...
  ['gworkspace', 'Google Workspace', 'Productivity', 'Workspace reference for productivity records.', 'configured', 'Northwind Workspace'],
  ...
  ['jira', 'Jira', 'Ticketing', 'Workspace reference for ticketing records.', 'configured', 'Northwind Atlassian'],
